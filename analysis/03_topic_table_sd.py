#!/usr/bin/env python3
"""
Generate Formatted Topic Table - SD (Story-Driven) Analysis
...
# Model input
MODEL_PATH = "data/derived/best_lda_model_SD_k3.model"

# Table parameters
NUM_KEYWORDS = 10           # Number of top keywords to display per topic
DECIMAL_PLACES = 4          # Number of decimal places for probabilities (e.g., 0.0108)
...
# Output files
OUTPUT_MARKDOWN = "output/tables/topic_table_SD_k3.md"
OUTPUT_CSV = "output/tables/topic_table_SD_k3.csv"
...
if __name__ == '__main__':
    ...
    if PRINT_TO_CONSOLE:
        print("\n" + "="*80)
        print("TOPIC TABLE - SD STORY-DRIVEN GAMES (K=2)")
        print("="*80 + "\n")
    ...
    if OUTPUT_MARKDOWN:
        with open(OUTPUT_MARKDOWN, 'w', encoding='utf-8') as f:
            f.write(f"# Topic Table - SD (Story-Driven) (K={model.num_topics})\n\n")
